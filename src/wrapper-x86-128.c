...
__m128 swapPairs32x4r(__m128 x) { return _mm_shuffle_ps(x, x, 0b10110001); }
__m128 swapLowHigh32x4r(__m128 x) { return _mm_shuffle_ps(x, x, 0b01001110); }
__m128 reverse32x4r(__m128 x) { return _mm_shuffle_ps(x, x, 0b00011011); }
__m128 rotateLeft32x4r(__m128 x) { return _mm_shuffle_ps(x, x, 0b00111001); }
__m128 rotateRight32x4r(__m128 x) { return _mm_shuffle_ps(x, x, 0b10010011); }
__m128 blendLowHigh32x4r(__m128 x, __m128 y) { return _mm_blend_ps(x, y, 0b1100); }
...
double extract64x2r0(__m128d x) { return _mm_cvtsd_f64(x); }
...
__m128d swapPairs64x2r(__m128d x) { return _mm_shuffle_pd(x, x, 1); }
__m128d blendLowHigh64x2r(__m128d x, __m128d y) { return _mm_blend_pd(x, y, 0b10); }
