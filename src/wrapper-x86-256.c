...
__m256 swapPairs32x8r(__m256 x) { return _mm256_permute_ps(x, 0xb1); }
__m256 swapLowHigh32x8r(__m256 x) { return _mm256_permute2f128_ps(x, x, 1); }
...
__m256 blendLowHigh32x8r(__m256 x, __m256 y) { return _mm256_blend_ps(x, y, 0xf0); }
...
__m256d swapPairs64x4r(__m256d x) { return _mm256_permute4x64_pd(x, 0xB1); }
__m256d swapLowHigh64x4r(__m256d x) { return _mm256_permute4x64_pd(x, 0x4E); }
__m256d reverse64x4r(__m256d x) { return _mm256_permute4x64_pd(x, 0x1B); }
__m256d rotateLeft64x4r(__m256d x) { return _mm256_permute4x64_pd(x, 0x39); }
__m256d rotateRight64x4r(__m256d x) { return _mm256_permute4x64_pd(x, 0x93); }
