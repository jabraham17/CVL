...
__m256 swapPairs32x8f(__m256 x);
__m256 swapLowHigh32x8f(__m256 x);
...
__m256d swapPairs64x4d(__m256d x);
__m256d swapLowHigh64x4d(__m256d x);
__m256d reverse64x4d(__m256d x);
__m256d rotateLeft64x4d(__m256d x);
__m256d rotateRight64x4d(__m256d x);
