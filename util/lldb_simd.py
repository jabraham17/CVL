...
def __lldb_init_module(debugger, dict):
    debugger.HandleCommand('type synthetic add --category simd --python-class lldb_simd.Simd128Printer __m128i')
    debugger.HandleCommand('type synthetic add --category simd --python-class lldb_simd.Simd256Printer __m256i')
    debugger.HandleCommand('type synthetic add --category simd --python-class lldb_simd.Simd512Printer __m512i')
