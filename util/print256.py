...
class M256iSynthProvider:
    ...
    def get_child_at_index(self, index):
        ...
        value = int.from_bytes(self.data.uint8s[offset:offset+2], byteorder='little', signed=False)
...
def __lldb_init_module(debugger, internal_dict):
    debugger.HandleCommand('type synthetic add -l print256.M256iSynthProvider __m256i -w simd')
    debugger.HandleCommand('type summary add __m256i -F print256.M256iSynthProvider.get_summary -w simd')
